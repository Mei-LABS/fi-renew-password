...
namespace MeiLABS\Filament\RenewPassword\Pages\Auth;
...
use MeiLABS\Filament\RenewPassword\Contracts\RenewPasswordContract;
                ...
                $this->makeForm()
                    ->schema([
                        ...
                        TextInput::make('password')
                            ...
                            ->password()
                            ->required()
                            ->rules(['different:data.currentPassword', config('filament-renew-password.password.rules')]),
